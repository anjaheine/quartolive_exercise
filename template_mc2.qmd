...
ojscorrect <- function(answerstud, answerkey) {
  if (checkbtn > 0)
    if (identical(answerstud, answerkey) == TRUE)
      return('<br><p><span style="color:green; font-weight:bold">Yes! Awesome!</span>')
    else
      return('<br><p><span style="color:red; font-weight:bold">Please try again...</span>')
  else
    return('')
}
